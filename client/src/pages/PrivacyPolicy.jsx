...
const PrivacyPolicy = () => {
  ...
  <div className='flex flex-col w-full min-h-screen items-center mb-4'>
    <Navbar />
    <br></br>
    <div className="mt-6" data-custom-class="body">
      <div>
        <strong>
          ...
          <strong>
            <span style={{ fontSize: 15 }}>
              <span data-custom-class="subtitle">
                Last updated <bdt className="question">August 09, 2022</bdt>
              </span>
            </span>
          </strong>
        </span>
        ...
        <span style={{ color: "rgb(127, 127, 127)" }}>
          <span style={{ color: "rgb(89, 89, 89)", fontSize: 15 }}>
            <span data-custom-class="body_text">
              ...
              <bdt className="question">Ayuh Tecnologies Pvt Ltd</bdt>
          ...
          <span style={{ fontSize: 15, color: "rgb(89, 89, 89)" }}>
            <span style={{ fontSize: 15, color: "rgb(89, 89, 89)" }}>
              <span data-custom-class="body_text">
                ...
                <bdt className="question">ayuhapp.com</bdt>
                <span style={{ fontSize: 15 }}>
                  <span style={{ color: "rgb(89, 89, 89)" }}>
                    <span data-custom-class="body_text">
                      <span style={{ fontSize: 15 }}>
      ...
      <div>
          ...
          <span style={{ fontSize: 15 }}>
            <span style={{ color: "rgb(127, 127, 127)" }}>
              <span data-custom-class="body_text">
                ...
                <bdt className="question">ayuh.official@gmail.com</bdt>.
              </span>
            </span>
          </span>
        </div>
        ...
        <div style={{ lineHeight: "1.5" }}>
          ...
          <a
            ...
            href="https://app.termly.io/notify/84690b98-12ce-4882-a518-f1835d14f8a5"
            ...
            <span style={{ fontSize: 15, color: "rgb(89, 89, 89)" }}>
              <span style={{ fontSize: 15, color: "rgb(89, 89, 89)" }}>
                <span data-custom-class="body_text">
                  <span style={{ fontSize: 15 }}>
                    <span data-custom-class="body_text">
                      <bdt className="question">medical records</bdt>
                    </span>
                  </span>
                </span>
              </span>
            ...
            <span style={{ fontSize: 15, color: "rgb(89, 89, 89)" }}>
              <span style={{ fontSize: 15, color: "rgb(89, 89, 89)" }}>
                <span data-custom-class="body_text">
                  <span style={{ fontSize: 15 }}>
                    <span data-custom-class="body_text">
                      <bdt className="question">location</bdt>
                    </span>
                  </span>
                </span>
              </span>
            ...
            <span style={{ fontSize: 15, color: "rgb(89, 89, 89)" }}>
              <span style={{ fontSize: 15, color: "rgb(89, 89, 89)" }}>
                <span data-custom-class="body_text">
                  <span style={{ fontSize: 15 }}>
                    <span data-custom-class="body_text">
                      <bdt className="question">doctor preferences</bdt>
                    </span>
                  </span>
                </span>
              </span>
                ...
                <span style={{ color: "rgb(89, 89, 89)" }}>
                  <span style={{ fontSize: 15 }}>
                    <span data-custom-class="body_text">
                      ...
                      your name, email address, and gender. Any personal
                      ...
                      <span style={{ fontSize: 15, color: "rgb(89, 89, 89)" }}>
                        <span style={{ fontSize: 15, color: "rgb(89, 89, 89)" }}>
                          <span data-custom-class="body_text">
                            ...
                            <bdt className="block-component" />
                            personalized
                            <bdt className="statement-end-if-in-editor" /> content
                            and advertising tailored to your interests, location,
                            and more.
                            <bdt className="block-component" />
                          </span>
                          <span data-custom-class="body_text">
                        ...
                        <li style={{ lineHeight: "1.5" }}>
                          <span data-custom-class="body_text">
                            <span style={{ fontSize: 15 }}>
                              ...
                              evaluate and improve our Services, products,
                              marketing, and your experience.
                            </span>
                          </span>
                          <bdt className="statement-end-if-in-editor">
                        ...
                        <div style={{ lineHeight: "1.5" }}>
                            ...
                            <li style={{ lineHeight: "1.5" }}>
                              <span style={{ fontSize: 15 }}>
                                <span data-custom-class="body_text">
                                  ...
                                  requests, and exercise, establish, or defend our
                                  legal rights.
                                  <bdt className="statement-end-if-in-editor" />
                                </span>
                              </span>
                          ...
                          <div style={{ lineHeight: "1.5" }}>
                            ...
                            <div style={{ lineHeight: "1.5" }}>
                              <span style={{ fontSize: 15 }}>
                                <span data-custom-class="body_text">
                                  ...
                                  work. <bdt className="block-component" />
                            ...
                            <ul>
                              <li style={{ lineHeight: "1.5" }}>
                                <span data-custom-class="body_text">
                                  Order <bdt className="block-component" />
                                  Fulfillment
                                  <bdt className="statement-end-if-in-editor" />{" "}
                                  Service Providers
                                </span>
                            ...
                            <ul>
                              <li style={{ lineHeight: "1.5" }}>
                                ...
                                <span style={{ fontSize: 15 }}>
                                  <span data-custom-class="body_text">
                                    .<bdt className="block-component" /> We use
                                    ...
                                    other similar information. A full list of what
                                    we use information for can be found in this
                                ...
                                <span style={{ fontSize: 15 }}>
                                  <span data-custom-class="body_text">
                                    ...
                                    <bdt className="statement-end-if-in-editor" />
                                    <bdt className="block-component" /> We obtain
                                    and store on your device (
                                    <bdt className="block-component" />
                                    "cache"
                                    <bdt className="statement-end-if-in-editor" />
                                    ) your location
                                    <bdt className="block-component" />. You may
                                    revoke your consent anytime by contacting us
                                    at the contact details provided at the end of
                                    this document.
                                    <bdt className="statement-end-if-in-editor" />
                                    <bdt className="block-component" /> The Google
                                    Maps Platform APIs that we use store and
                                    access cookies and other information on your
                                    devices. If you are a user currently in the
                                    European Economic Area (EU countries, Iceland,
                                    Liechtenstein, and Norway) or the United
                                    Kingdom, please take a look at our Cookie
                                    Notice
                                    <bdt className="block-component" />.
                                    <bdt className="statement-end-if-in-editor" />
                                  </span>
                              ...
                              <li style={{ lineHeight: "1.5" }}>
                                <span style={{ fontSize: 15 }}>
                                  <span data-custom-class="body_text">
                                    ...
                                    personal information
                                    <bdt className="block-component" /> (for
                                    example, by posting comments, contributions,
                                    or other content to the Services)
                                    <bdt className="statement-end-if-in-editor" />{" "}
                                    or otherwise interact with public areas of the
                                    Services, such personal information may be
                                    viewed by all users and may be publicly made
                                    available outside the Services in perpetuity.
                                    <bdt className="block-component" /> If you
                                    interact with other users of our Services and
                                    register for our Services through a social
                                    network (such as Facebook), your contacts on
                                    the social network will see your name, profile
                            ...
                            <div style={{ lineHeight: "1.5" }}>
                              ...
                              <div style={{ lineHeight: "1.5" }}>
                                <strong>
                                  <span id="3pwebsites" style={{ fontSize: 15 }}>
                                    <span data-custom-class="heading_1">
                                      4. WHAT IS OUR STANCE ON THIRD-PARTY
                                      WEBSITES?
                                    </span>
                                  </span>
                                </strong>
                              ...
                              <div style={{ lineHeight: "1.5" }}>
                                <span style={{ fontSize: 15 }}>
                                  <span data-custom-class="body_text">
                                    ...
                                    <em>
                                      &nbsp;We are not responsible for the safety
                                      of any information that you share with third
                              ...
                              <div style={{ lineHeight: "1.5" }}>
                                <span style={{ fontSize: 15 }}>
                                  <span data-custom-class="body_text">
                                    The Services
                                    <bdt className="block-component" /> may link
                                    to third-party websites, online services, or
                                    mobile applications and/or contain
                              ...
                              <div style={{ lineHeight: "1.5" }}>
                                <span style={{ fontSize: 15 }}>
                                  <span data-custom-class="body_text">
                                    ...
                                    on the unsubscribe link in the emails that we
                                    send,
                                    <bdt className="statement-end-if-in-editor" />
                                    <bdt className="block-component" /> replying{" "}
                                    <bdt className="block-component" />
                                    "STOP" or "UNSUBSCRIBE"
                                    <bdt className="statement-end-if-in-editor" />{" "}
