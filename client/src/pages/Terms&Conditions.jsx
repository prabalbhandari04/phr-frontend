...
const Terms = () => {
  ...
  />
  <div className='flex flex-col w-full min-h-screen items-center mb-4'>
    <Navbar />
    <br></br>
    <>
  <style
  ...
  <div data-custom-class="body">
    ...
    <div align="center" style={{ textAlign: "left", lineHeight: "1.5" }}>
      <a data-custom-class="link" href="#ip">
        <span style={{ fontSize: 15 }}>
          <span data-custom-class="body_text">2. INTELLECTUAL PROPERTY</span>
        </span>
      </a>
    </div>
    <div align="center" style={{ textAlign: "left", lineHeight: "1.5" }}>
    ...
    <div align="center" style={{ textAlign: "left", lineHeight: "1.5" }}>
      <a data-custom-class="link" href="#marketplace">
        <span style={{ fontSize: 15 }}>
          <span data-custom-class="body_text">5. MARKETPLACE OFFERINGS</span>
        </span>
      </a>
    </div>
    <div align="center" style={{ textAlign: "left", lineHeight: "1.5" }}>
    ...
    <div align="center" style={{ textAlign: "left", lineHeight: "1.5" }}>
      ...
      <a data-custom-class="link" href="#refunds1">
        <span style={{ fontSize: 15 }}>
    ...
    <div align="center" style={{ textAlign: "left", lineHeight: "1.5" }}>
      ...
      <a data-custom-class="link" href="#reviews">
        <span style={{ fontSize: 15 }}>
          <span data-custom-class="body_text">11. GUIDELINES FOR REVIEWS</span>
        </span>
      </a>
      <span style={{ fontSize: 15 }}>
        <bdt className="statement-end-if-in-editor">
    ...
    <div align="center" style={{ textAlign: "left", lineHeight: "1.5" }}>
      ...
      <a data-custom-class="link" href="#socialmedia">
        <span style={{ fontSize: 15 }}>
          <span data-custom-class="body_text">13. SOCIAL MEDIA</span>
        </span>
      </a>
      <span style={{ fontSize: 15 }}>
        <bdt className="statement-end-if-in-editor">
    ...
    <div align="center" style={{ textAlign: "left", lineHeight: "1.5" }}>
      <a data-custom-class="link" href="#submissions">
        <span style={{ fontSize: 15 }}>
          <span data-custom-class="body_text">14. SUBMISSIONS</span>
        </span>
      </a>
    </div>
    <div align="center" style={{ textAlign: "left", lineHeight: "1.5" }}>
    ...
    <div align="center" style={{ textAlign: "left", lineHeight: "1.5" }}>
      ...
      <a data-custom-class="link" href="#advertisers">
        <span style={{ fontSize: 15 }}>
          <span data-custom-class="body_text">16. ADVERTISERS</span>
        </span>
      </a>
      <span style={{ fontSize: 15 }}>
        <bdt className="statement-end-if-in-editor">
    ...
    <div align="center" style={{ textAlign: "left", lineHeight: "1.5" }}>
      <a data-custom-class="link" href="#sitemanage">
        <span style={{ fontSize: 15 }}>
          <span data-custom-class="body_text">17. SITE MANAGEMENT</span>
        </span>
      </a>
    </div>
    <div align="center" style={{ textAlign: "left", lineHeight: "1.5" }}>
      ...
      <a data-custom-class="link" href="#privacypolicy1">
        <span style={{ fontSize: 15 }}>
          <span data-custom-class="body_text">18. PRIVACY POLICY</span>
        </span>
      </a>
      <span style={{ fontSize: 15 }}>
        <span data-custom-class="body_text">
    ...
    <div align="center" style={{ textAlign: "left", lineHeight: "1.5" }}>
      ...
      <a data-custom-class="link" href="#copyright2">
        <span style={{ fontSize: 15 }}>
          <span data-custom-class="body_text">19. COPYRIGHT INFRINGEMENTS</span>
        </span>
      </a>
      <span style={{ fontSize: 15 }}>
        <span data-custom-class="body_text">
    ...
    <div align="center" style={{ textAlign: "left", lineHeight: "1.5" }}>
      <a data-custom-class="link" href="#term">
        <span style={{ fontSize: 15 }}>
          <span data-custom-class="body_text">20. TERM AND TERMINATION</span>
        </span>
      </a>
    </div>
    <div align="center" style={{ textAlign: "left", lineHeight: "1.5" }}>
    ...
    <div align="center" style={{ textAlign: "left", lineHeight: "1.5" }}>
      <a data-custom-class="link" href="#law">
        <span style={{ fontSize: 15 }}>
          <span data-custom-class="body_text">22. GOVERNING LAW</span>
        </span>
      </a>
    </div>
    <div align="center" style={{ textAlign: "left", lineHeight: "1.5" }}>
      <a data-custom-class="link" href="#disputes">
        <span style={{ fontSize: 15 }}>
          <span data-custom-class="body_text">23. DISPUTE RESOLUTION</span>
        </span>
      </a>
    </div>
    <div align="center" style={{ textAlign: "left", lineHeight: "1.5" }}>
      <a data-custom-class="link" href="#corrections">
        <span style={{ fontSize: 15 }}>
          <span data-custom-class="body_text">24. CORRECTIONS</span>
        </span>
      </a>
    </div>
    <div align="center" style={{ textAlign: "left", lineHeight: "1.5" }}>
      <a data-custom-class="link" href="#disclaimer">
        <span style={{ fontSize: 15 }}>
          <span data-custom-class="body_text">25. DISCLAIMER</span>
        </span>
      </a>
    </div>
    <div align="center" style={{ textAlign: "left", lineHeight: "1.5" }}>
    ...
    <div align="center" style={{ textAlign: "left", lineHeight: "1.5" }}>
      <a data-custom-class="link" href="#indemnification">
        <span style={{ fontSize: 15 }}>
          <span data-custom-class="body_text">27. INDEMNIFICATION</span>
        </span>
      </a>
    </div>
    <div align="center" style={{ textAlign: "left", lineHeight: "1.5" }}>
      <a data-custom-class="link" href="#userdata">
        <span style={{ fontSize: 15 }}>
          <span data-custom-class="body_text">28. USER DATA</span>
        </span>
      </a>
    </div>
    <div align="center" style={{ textAlign: "left", lineHeight: "1.5" }}>
    ...
    <div align="center" style={{ textAlign: "left", lineHeight: "1.5" }}>
      <a data-custom-class="link" href="#misc">
        <span style={{ fontSize: 15 }}>
          <span data-custom-class="body_text">30. MISCELLANEOUS</span>
        </span>
      </a>
    </div>
    <div align="center" style={{ textAlign: "left", lineHeight: "1.5" }}>
      <a data-custom-class="link" href="#contact">
        <span style={{ fontSize: 15 }}>
          <span data-custom-class="body_text">31. CONTACT US</span>
        </span>
      </a>
    </div>
    <div align="center" style={{ textAlign: "left", lineHeight: "1.5" }}>
          ...
          >
            <span
              style={{
                ...
                msoStyleTextfillFillColortransforms: '"lumm=65000 lumo=35000"'
              }}
            >
              ...
              <span style={{ fontSize: "14.6667px" }}>
                ...
                <bdt className="question">Ayuh</bdt>
                <bdt className="statement-end-if-in-editor" /> ("
                <bdt className="block-component" />
            ...
            >
              ...
              Offerings, you have read, understood, and agree to be bound by all
    ...
    <div align="center" style={{ textAlign: "left" }}>
      ...
      >
        ...
        <span style={{ color: "rgb(89, 89, 89)", fontSize: "11pt" }}>
          ) you will not access the Site or the Marketplace Offerings through
        ...
        <span style={{ color: "rgb(89, 89, 89)", fontSize: "11pt" }}>
          ) your use of the Site or the Marketplace Offerings will not violate
          ...
          <bdt data-type="body">
            ...
            >
              ...
              >
                ...
                and password. We reserve the right to remove, reclaim, or change
                a username you select if we determine, in our sole discretion,
    ...
    <div align="center" style={{ textAlign: "left", lineHeight: "1.5" }}>
      ...
      >
        ...
        >
          ...
          <bdt className="question">Indian Rupees</bdt>.
        </span>
      </div>
    </div>
    <div align="center" style={{ textAlign: "left", lineHeight: 1 }}>
          ...
          <bdt data-type="conditional-block">
            <bdt data-type="body">
              ...
              >
                ...
                >
                  <span style={{ fontSize: "11pt", textAlign: "left" }}>
            ...
            >
              <ul>
                <li
                  ...
                  style={{ lineHeight: "1.5", textAlign: "left" }}
                >
                  <span style={{ color: "rgb(89, 89, 89)", fontSize: 14 }}>
                    <span data-custom-class="body_text">
          ...
          <bdt data-type="body">
            ...
            >
              ...
              >
                ...
                the Site. You will have the ability to disable the connection
                between your account on the Site and your{" "}
                <span style={{ fontSize: "14.6667px" }}>Third-Party</span>{" "}
          ...
          <bdt data-type="body">
            ...
            >
              ...
              >
                ...
                you decide to leave the Site and access the{" "}
                <span style={{ fontSize: "14.6667px" }}>Third-Party</span>{" "}
                ...
                the Site. Any purchases you make through{" "}
                <span style={{ fontSize: "14.6667px" }}>Third-Party</span>{" "}
          ...
          <bdt data-type="body">
            ...
            >
              ...
              >
                ...
                <bdt className="statement-end-if-in-editor" />
                <bdt className="forloop-component" />
                <bdt className="statement-end-if-in-editor" />, and you agree to
    ...
    <div
      ...
      style={{ textAlign: "left", lineHeight: "1.5" }}
    >
      <strong>19. COPYRIGHT INFRINGEMENTS</strong>
    </div>
    <div align="center" style={{ textAlign: "left", lineHeight: 1 }}>
      <br />
    </div>
    ...
    <div align="center" style={{ textAlign: "left" }}>
      ...
      >
        ...
        <strong>
          <span style={{ lineHeight: "115%", fontFamily: "Arial" }}>
            <span style={{ fontSize: 19 }}>22. GOVERNING LAW</span>
          </span>
        </strong>
      </div>
    </div>
    ...
    <div align="center" style={{ textAlign: "left" }}>
      ...
      >
        ...
        >
          ...
          . <bdt className="question">Ayuh Technologies</bdt> and yourself
          ...
          <bdt data-type="body">
            ...
            >
              <span style={{ fontSize: 15 }}>
                ...
                <bdt className="question">thirty (30)</bdt> days before
    ...
    >
      <span style={{ fontSize: 15 }}>
        ...
        arbitrators shall be <bdt className="question">one (1)</bdt>. The seat,
        ...
        >
          <bdt className="block-component" />
          <bdt className="question">Gurgaon,Haryana or remote</bdt>,{" "}
          <bdt className="block-component" />
        </span>
        <bdt className="question">India</bdt>
        <bdt className="statement-end-if-in-editor" />
      ...
      <bdt className="question">English or any that is comfortable</bdt>. The
    ...
    >
      ...
      >
        ...
        Marketplace Offerings; (<span style={{ fontSize: "14.6667px" }}>3</span>
    ...
    >
      <strong>
        <span style={{ lineHeight: "115%", fontFamily: "Arial" }}>
          <span style={{ fontSize: 19 }}>31. CONTACT US</span>
        </span>
      </strong>
    </div>
    <div className="MsoNormal" style={{ textAlign: "left", lineHeight: 1 }}>
    ...
    >
      ...
      >
        <bdt
          ...
          data-type="question"
        >
          <strong>Ayuh Technologies</strong>
        </bdt>
      </span>
      <strong>
    ...
    >
      <strong>
        <span style={{ fontSize: 15, color: "rgb(89, 89, 89)" }}>Phone:</span>
        &nbsp;
      </strong>
      <strong>
        <span style={{ color: "rgb(89, 89, 89)" }}>
    ...
    >
      ...
      >
        <bdt
          ...
          data-type="question"
        >
          <strong>ayuh.official@gmail.com</strong>
        </bdt>
      </span>
    </div>
  </div>
